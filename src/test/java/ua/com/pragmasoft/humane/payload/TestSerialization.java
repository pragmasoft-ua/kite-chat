...
public class TestSerialization {
  ...
  static final Encoder.Binary<HumaneMsg> ENCODER = new MsgPackHumaneEncoder();
  static final Decoder.Binary<HumaneMsg> DECODER = new MsgPackHumaneDecoder();
  ...
  public void testSerializeAndDeserialize(HumaneMsg msg) throws EncodeException, DecodeException {
