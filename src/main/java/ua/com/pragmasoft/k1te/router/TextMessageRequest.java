...
public record TextMessageRequest(MessageId id,Route origin,Instant timestamp,String text,Entity[]entities,Optional<ConversationId>conversationId)implements Request<TextMessageRequest,MessageResponse>{
