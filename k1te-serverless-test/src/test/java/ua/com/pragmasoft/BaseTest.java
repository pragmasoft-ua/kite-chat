...
class BaseTest {
    ...
    protected static final String TELEGRAM_CHANNEL_NAME = "k1te_test";
    protected static final String KITE_CHAT_URL_WITH_CHANNEL =
        System.getProperty("kite.url", "https://www.k1te.chat/test") + "?c="
    ...
    static void createGroups() {
        ...
        try (playwright;
            ...
            telegramClientPage.openChatConfig(TELEGRAM_HOST_CHAT_TITLE)
                .makeAdmin(TELEGRAM_BOT_NAME);

            telegramClientPage.createGroupWithBot(TELEGRAM_MEMBER_CHAT_TITLE, TELEGRAM_BOT_NAME);
            telegramClientPage.openChatConfig(TELEGRAM_MEMBER_CHAT_TITLE)
                .makeAdmin(TELEGRAM_BOT_NAME);
            successFlag = true;
        }
    }
    ...
    public static void sendTextAndVerifyResponse(ChatPage chat, String text,
        String expected) {
