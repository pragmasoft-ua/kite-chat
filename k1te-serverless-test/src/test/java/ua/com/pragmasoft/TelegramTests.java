...
//    telegramChat
//        .lastMessage(ChatPage.MessageType.IN)
...
//    telegramChat.lastMessage(ChatPage.MessageType.IN).hasText("Created channel " + CHANNEL_NAME);
//  }
//
//  @Test
//  @Order(3)
...
//    telegramChat.lastMessage(ChatPage.MessageType.IN).hasText("Host member cannot leave channel.");
//  }
//
//  @Test
//  @Order(5)
