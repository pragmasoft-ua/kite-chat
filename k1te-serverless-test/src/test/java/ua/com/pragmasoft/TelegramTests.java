...
class TelegramTests {
  ...
  //    telegramChat.lastMessage(ChatPage.MessageType.IN).hasText("Created channel " +
  // CHANNEL_NAME);
  //  }
  //
  //  @Test
  ...
  //    telegramChat.lastMessage(ChatPage.MessageType.IN).hasText("Host member cannot leave
  // channel.");
  //  }
  //
  //  @Test
