...
/**
 * Represents a chat message within a chat interface, providing methods for validation and interaction.
 * Implementing classes should define specific behaviors related to text, file attachments, photos,
 * and synchronization of message upload status.
 *
 * <p>The {@code ChatMessage} interface facilitates the validation of various aspects of a chat message,
 * including its text content, attached files, and the presence of photos. It also offers functionality
 * to wait for the message to be uploaded and to create a snapshot for targeting a specific instance of
...
public interface ChatMessage {
  ...
  /**
   * Creates a snapshot of the current state of the chat message.
   * This is especially useful for targeting specific messages within the chat.
   *
   * @return A reference to the same {@code ChatMessage} instance for method chaining.
   */
  ...
  /**
   * Retrieves the locator associated with the chat message.
   * The locator is used to identify and interact with the corresponding element in the chat.
   *
